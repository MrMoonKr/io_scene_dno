...
class MshImporter:
    ...
    def import_data(self, context: bpy.types.Context, options):
        ...
        append_armature: Object = options.get("append_armature", False)

        if append_armature:
            arm_obj: Object = append_armature
            arm: Armature = arm_obj.data
    ...
    def load_file( self, context: Context, filename: str ) -> bool:
        self.msh = MSH()
